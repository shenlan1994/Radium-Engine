...
bool TMOperations::splitEdge( TopologicalMesh& mesh, TopologicalMesh::EdgeHandle eh, Scalar f ) {
    ...
    */
    ...
    if ( !mesh.is_boundary( he0 ) )
    {
        ...
        // interpolate at he2
        interpolateProps( mesh.m_floatPph, h1, he0, he2, 0.5, mesh );
        interpolateProps( mesh.m_vec2Pph, h1, he0, he2, 0.5, mesh );
        interpolateProps( mesh.m_vec3Pph, h1, he0, he2, 0.5, mesh );
        interpolateProps( mesh.m_vec4Pph, h1, he0, he2, 0.5, mesh );
        // copy at e0, and e2
        copyProps( mesh.m_floatPph, he2, e0, mesh );
        copyProps( mesh.m_vec2Pph, he2, e0, mesh );
        copyProps( mesh.m_vec3Pph, he2, e0, mesh );
        copyProps( mesh.m_vec4Pph, he2, e0, mesh );
        copyProps( mesh.m_floatPph, h0, e2, mesh );
        copyProps( mesh.m_vec2Pph, h0, e2, mesh );
        copyProps( mesh.m_vec3Pph, h0, e2, mesh );
        copyProps( mesh.m_vec4Pph, h0, e2, mesh );
    } else
    {
    ...
    if ( !mesh.is_boundary( he1 ) )
    {
        ...
        interpolateProps( mesh.m_vec3Pph, o0, he3, he1, 0.5, mesh );
        interpolateProps( mesh.m_vec4Pph, o0, he3, he1, 0.5, mesh );
        // copy at e1, and e3
        copyProps( mesh.m_floatPph, he1, e3, mesh );
        copyProps( mesh.m_vec2Pph, he1, e3, mesh );
        copyProps( mesh.m_vec3Pph, he1, e3, mesh );
        copyProps( mesh.m_vec4Pph, he1, e3, mesh );
        copyProps( mesh.m_floatPph, o1, e1, mesh );
        copyProps( mesh.m_vec2Pph, o1, e1, mesh );
        copyProps( mesh.m_vec3Pph, o1, e1, mesh );
        copyProps( mesh.m_vec4Pph, o1, e1, mesh );
    } else
    {
        HeHandle o1 = mesh.next_halfedge_handle( he1 );
